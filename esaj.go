...
func NewESAJClient(config Config, client *http.Client) *ESAJClient {
	return &ESAJClient{
		Config: config,
		Client: client,
...
func (ec ESAJClient) SearchDo(processID string) (string, error) {
...
func GetPDF(ctx context.Context, cookiePDFSession string, cData ChildrenData) error {
	processID, err := getContextWithProcessID(ctx, ProcessIDContextKey)
	if err != nil {
		return fmt.Errorf("error getting processID from context: %w", err)
	}

	hrefGetPDF := "https://esaj.tjsp.jus.br/pastadigital/getPDF.do?" + cData.Parametros
...
// - cookieSession: The dynamic cookie generated by the TJSP. This should be include the JSESSIONID and K-JSESSIONID-nckcjpip.
// Example of cookieSession: "JSESSIONID=EACA3333A48456D7953B6331999A4F80.cas11; K-JSESSIONID-nckcjpip=0E4D006FFD78524DBABA78F02E1633FA"
func (ec ESAJClient) pastaDigitalURL(processCode string) (string, error) {
